...
export type LP_PRODUCT_FAQCreationAttributes = Optional<
  LP_PRODUCT_FAQAttributes,
  LP_PRODUCT_FAQOptionalAttributes
>;

export class LP_PRODUCT_FAQ
  extends Model<LP_PRODUCT_FAQAttributes, LP_PRODUCT_FAQCreationAttributes>
  implements LP_PRODUCT_FAQAttributes
{
  id!: string;
  productId!: string;
  question!: string;
