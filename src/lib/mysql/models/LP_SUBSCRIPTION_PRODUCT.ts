...
export type LP_SUBSCRIPTION_PRODUCTId = LP_SUBSCRIPTION_PRODUCT[LP_SUBSCRIPTION_PRODUCTPk];
export type LP_SUBSCRIPTION_PRODUCTOptionalAttributes = "createdAt" | "updatedAt";
export type LP_SUBSCRIPTION_PRODUCTCreationAttributes = Optional<LP_SUBSCRIPTION_PRODUCTAttributes, LP_SUBSCRIPTION_PRODUCTOptionalAttributes>;

export class LP_SUBSCRIPTION_PRODUCT extends Model<LP_SUBSCRIPTION_PRODUCTAttributes, LP_SUBSCRIPTION_PRODUCTCreationAttributes> implements LP_SUBSCRIPTION_PRODUCTAttributes {
  subscriptionId!: string;
  productId!: string;
  quantity!: number;
  createdAt!: Date;
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof LP_SUBSCRIPTION_PRODUCT {
