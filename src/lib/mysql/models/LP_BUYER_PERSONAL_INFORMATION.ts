...
export type LP_BUYER_PERSONAL_INFORMATIONId =
  LP_BUYER_PERSONAL_INFORMATION[LP_BUYER_PERSONAL_INFORMATIONPk];
export type LP_BUYER_PERSONAL_INFORMATIONOptionalAttributes =
  | 'gender'
  | 'birthday'
  | 'age';
export type LP_BUYER_PERSONAL_INFORMATIONCreationAttributes = Optional<
  LP_BUYER_PERSONAL_INFORMATIONAttributes,
  LP_BUYER_PERSONAL_INFORMATIONOptionalAttributes
>;

export class LP_BUYER_PERSONAL_INFORMATION
  extends Model<
    LP_BUYER_PERSONAL_INFORMATIONAttributes,
    LP_BUYER_PERSONAL_INFORMATIONCreationAttributes
  >
  implements LP_BUYER_PERSONAL_INFORMATIONAttributes
{
  buyerId!: string;
  nickname!: string;
  firstName!: string;
  ...
  ): typeof LP_BUYER_PERSONAL_INFORMATION {
