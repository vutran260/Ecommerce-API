...
export type SeederMetaCreationAttributes = Optional<
  SeederMetaAttributes,
  SeederMetaOptionalAttributes
>;

export class SeederMeta
  extends Model<SeederMetaAttributes, SeederMetaCreationAttributes>
  implements SeederMetaAttributes
{
  id!: number;
  seederName!: string;
  createdAt!: Date;
