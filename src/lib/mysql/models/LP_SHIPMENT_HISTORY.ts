...
export type LP_SHIPMENT_HISTORYOptionalAttributes =
  | 'id'
  | 'shipmentHistoryDate'
  | 'shipmentStatus'
  | 'shipmentDescription'
  ...
  | 'updatedAt'
  | 'deletedAt';
export type LP_SHIPMENT_HISTORYCreationAttributes = Optional<
  LP_SHIPMENT_HISTORYAttributes,
  LP_SHIPMENT_HISTORYOptionalAttributes
>;

export class LP_SHIPMENT_HISTORY
  extends Model<
    LP_SHIPMENT_HISTORYAttributes,
    LP_SHIPMENT_HISTORYCreationAttributes
  >
  implements LP_SHIPMENT_HISTORYAttributes
{
  id!: string;
  shipmentHistoryDate?: Date;
  shipmentStatus?: string;
