...
export type LP_ORDER_PAYMENTOptionalAttributes =
  ...
  | 'updatedAt'
  | 'deletedAt';
export type LP_ORDER_PAYMENTCreationAttributes = Optional<
  LP_ORDER_PAYMENTAttributes,
  LP_ORDER_PAYMENTOptionalAttributes
>;

export class LP_ORDER_PAYMENT
  extends Model<LP_ORDER_PAYMENTAttributes, LP_ORDER_PAYMENTCreationAttributes>
  implements LP_ORDER_PAYMENTAttributes
{
  orderId!: number;
  paymentType?: string;
  paymentStatus?: string;
