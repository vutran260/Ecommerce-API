...
export type LP_PREFECTURESCreationAttributes = Optional<LP_PREFECTURESAttributes, LP_PREFECTURESOptionalAttributes>;

export class LP_PREFECTURES extends Model<LP_PREFECTURESAttributes, LP_PREFECTURESCreationAttributes> implements LP_PREFECTURESAttributes {
  id!: number;
  prefectureName?: string;
