...
export type LP_PRODUCT_CATEGORYCreationAttributes = Optional<
  LP_PRODUCT_CATEGORYAttributes,
  LP_PRODUCT_CATEGORYOptionalAttributes
>;

export class LP_PRODUCT_CATEGORY
  extends Model<
    LP_PRODUCT_CATEGORYAttributes,
    LP_PRODUCT_CATEGORYCreationAttributes
  >
  implements LP_PRODUCT_CATEGORYAttributes
{
  productId!: string;
  categoryId!: string;
  createdAt?: Date;
