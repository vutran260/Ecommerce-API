...
export type LP_SELLEROptionalAttributes =
  | 'id'
  | 'prefectureId'
  | 'storeId'
  | 'email'
  ...
  | 'updatedAt'
  | 'deletedAt';
export type LP_SELLERCreationAttributes = Optional<
  LP_SELLERAttributes,
  LP_SELLEROptionalAttributes
>;

export class LP_SELLER
  extends Model<LP_SELLERAttributes, LP_SELLERCreationAttributes>
  implements LP_SELLERAttributes
{
  id!: string;
  prefectureId?: string;
  storeId?: string;
