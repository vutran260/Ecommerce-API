...
export type LP_SUBSCRIPTION_ADDRESSId = LP_SUBSCRIPTION_ADDRESS[LP_SUBSCRIPTION_ADDRESSPk];
export type LP_SUBSCRIPTION_ADDRESSOptionalAttributes = "gender" | "createdAt" | "updatedAt";
export type LP_SUBSCRIPTION_ADDRESSCreationAttributes = Optional<LP_SUBSCRIPTION_ADDRESSAttributes, LP_SUBSCRIPTION_ADDRESSOptionalAttributes>;

export class LP_SUBSCRIPTION_ADDRESS extends Model<LP_SUBSCRIPTION_ADDRESSAttributes, LP_SUBSCRIPTION_ADDRESSCreationAttributes> implements LP_SUBSCRIPTION_ADDRESSAttributes {
  subscriptionId!: string;
  firstNameKana!: string;
  lastNameKana!: string;
  firstNameKanji!: string;
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof LP_SUBSCRIPTION_ADDRESS {
