...
import type { LP_SUBSCRIPTION_ADDRESS, LP_SUBSCRIPTION_ADDRESSCreationAttributes, LP_SUBSCRIPTION_ADDRESSId } from './LP_SUBSCRIPTION_ADDRESS';
...
export class LP_SUBSCRIPTION extends Model<LP_SUBSCRIPTIONAttributes, LP_SUBSCRIPTIONCreationAttributes> implements LP_SUBSCRIPTIONAttributes {
  ...
  setOrderIdLpOrders!: Sequelize.BelongsToManySetAssociationsMixin<LP_ORDER, LP_ORDERId>;
  addOrderIdLpOrder!: Sequelize.BelongsToManyAddAssociationMixin<LP_ORDER, LP_ORDERId>;
  addOrderIdLpOrders!: Sequelize.BelongsToManyAddAssociationsMixin<LP_ORDER, LP_ORDERId>;
  createOrderIdLpOrder!: Sequelize.BelongsToManyCreateAssociationMixin<LP_ORDER>;
  removeOrderIdLpOrder!: Sequelize.BelongsToManyRemoveAssociationMixin<LP_ORDER, LP_ORDERId>;
  removeOrderIdLpOrders!: Sequelize.BelongsToManyRemoveAssociationsMixin<LP_ORDER, LP_ORDERId>;
  hasOrderIdLpOrder!: Sequelize.BelongsToManyHasAssociationMixin<LP_ORDER, LP_ORDERId>;
  hasOrderIdLpOrders!: Sequelize.BelongsToManyHasAssociationsMixin<LP_ORDER, LP_ORDERId>;
  ...
  setProductIdLpProductLpSubscriptionProducts!: Sequelize.BelongsToManySetAssociationsMixin<LP_PRODUCT, LP_PRODUCTId>;
  addProductIdLpProductLpSubscriptionProduct!: Sequelize.BelongsToManyAddAssociationMixin<LP_PRODUCT, LP_PRODUCTId>;
  addProductIdLpProductLpSubscriptionProducts!: Sequelize.BelongsToManyAddAssociationsMixin<LP_PRODUCT, LP_PRODUCTId>;
  createProductIdLpProductLpSubscriptionProduct!: Sequelize.BelongsToManyCreateAssociationMixin<LP_PRODUCT>;
  removeProductIdLpProductLpSubscriptionProduct!: Sequelize.BelongsToManyRemoveAssociationMixin<LP_PRODUCT, LP_PRODUCTId>;
  removeProductIdLpProductLpSubscriptionProducts!: Sequelize.BelongsToManyRemoveAssociationsMixin<LP_PRODUCT, LP_PRODUCTId>;
  hasProductIdLpProductLpSubscriptionProduct!: Sequelize.BelongsToManyHasAssociationMixin<LP_PRODUCT, LP_PRODUCTId>;
  hasProductIdLpProductLpSubscriptionProducts!: Sequelize.BelongsToManyHasAssociationsMixin<LP_PRODUCT, LP_PRODUCTId>;
  ...
  setLpSubscriptionAddress!: Sequelize.HasOneSetAssociationMixin<LP_SUBSCRIPTION_ADDRESS, LP_SUBSCRIPTION_ADDRESSId>;
