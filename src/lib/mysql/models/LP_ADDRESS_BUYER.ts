...
export type LP_ADDRESS_BUYEROptionalAttributes =
  | 'id'
  | 'gender'
  | 'prefectureName'
  | 'agreed'
  ...
  | 'createdAt'
  | 'updatedAt';
export type LP_ADDRESS_BUYERCreationAttributes = Optional<
  LP_ADDRESS_BUYERAttributes,
  LP_ADDRESS_BUYEROptionalAttributes
>;

export class LP_ADDRESS_BUYER
  extends Model<LP_ADDRESS_BUYERAttributes, LP_ADDRESS_BUYERCreationAttributes>
  implements LP_ADDRESS_BUYERAttributes
{
  id!: string;
  buyerId!: string;
  storeId!: string;
