...
export type LP_CARTOptionalAttributes =
  ...
  | 'updatedAt'
  | 'updatedBy';
export type LP_CARTCreationAttributes = Optional<
  LP_CARTAttributes,
  LP_CARTOptionalAttributes
>;

export class LP_CART
  extends Model<LP_CARTAttributes, LP_CARTCreationAttributes>
  implements LP_CARTAttributes
{
  id!: string;
  buyerId!: string;
  storeId!: string;
