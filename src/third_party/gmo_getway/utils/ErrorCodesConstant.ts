...
export const errorCodesConstant: ErrorCodeMap = {
  '42C010000':
    '通信エラー(CAFISまたはカード会社障害)/カード所有者に取引失敗を表示し、問い吅わせにて状況を確認して下さい。',
  '42C030000':
    '通信エラー(CAFISまたはカード会社障害)/カード所有者に取引失敗を表示し、問い吅わせにて状況を確認して下さい。',
  '42C120000':
    '通信エラー(CAFISまたはカード会社障害)/カード所有者に取引失敗を表示し、問い吅わせにて状況を確認して下さい。',
  ...
  '42C780000':
    '通信エラー(CAFISまたはカード会社障害)/カード所有者に取引失敗を表示し、問い吅わせにて状況を確認して下さい。',
  '42G020000':
    'カード会社オーソリエラー/指定されたカードのオーソリが失敗した஦を通知して下さい。',
  '42G030000':
    'カード会社オーソリエラー/指定されたカードのオーソリが失敗した஦を通知して下さい。',
  '42G040000':
    'カード会社オーソリエラー/指定されたカードのオーソリが失敗した஦を通知して下さい。',
  ...
  '42G610000':
    'カード会社オーソリエラー/指定されたカードのオーソリが失敗した஦を通知して下さい。',
  '42G650000':
    'カード会社オーソリエラー/指定されたカードのオーソリが失敗した஦を通知して下さい。カード番号の再入力依頼をして下さい。',
  '42G670000':
    'カード会社オーソリエラー/指定されたカードのオーソリが失敗した஦を通知して下さい。詳細はカード会社にお問い吅わせ下さい。',
  '42G680000':
    'カード会社オーソリエラー/指定されたカードのオーソリが失敗した஦を通知して下さい。詳細はカード会社にお問い吅わせ下さい。',
  '42G690000':
    'カード会社オーソリエラー/指定されたカードのオーソリが失敗した஦を通知して下さい。詳細はカード会社にお問い吅わせ下さい。',
  ...
  '42G760000':
    'カード会社オーソリエラー/指定されたカードのオーソリが失敗した஦を通知して下さい。詳細はカード会社にお問い吅わせ下さい。',
  '42G770000':
    'カード会社オーソリエラー/指定されたカードのオーソリが失敗した஦を通知して下さい。詳細はお問い吅わせ下さい。',
  '42G780000':
    'カード会社オーソリエラー/指定されたカードのオーソリが失敗した஦を通知して下さい。詳細はお問い吅わせ下さい。',
  '42G790000':
    'カード会社オーソリエラー/指定されたカードのオーソリが失敗した஦を通知して下さい。詳細はお問い吅わせ下さい。',
  ...
  AMPL40010:
    '後続センターにて処理取消エラーが発生し、有効な初回課金が残りました。',
  ...
  AU1000002:
    '【決済要求】後続決済センターとの通信パラメータでエラーが発生しました。(受信パラメータ)',
  AU1000003: '【決済要求】後続決済センターで障害取消が実施されました。',
  AU1000004: '【決済要求】 auかんたんOpenID連携解除でエラーが発生しました。',
  AU1000005:
    '【操作キャンセル】 auかんたん決済でお宠様がお支払をキャンセルしました。',
  AU1000006:
    '【決済要求】後続決済センターで処理取消を実行し、取消に失敗しました。',
  AU2000007: '【課金確認】有効なユーザーでありません。',
  B01000002:
    '【決済結果問吅せ】楽天Edyセンタから発信する決済開始メールが不達となりました。不達の原因は、携帯端末側のメールアドレス変更、ドメイン拒否等が考えられます。',
  B01000003: '【決済結果問吅せ】楽天Edyセンタに該当の注文番号が存在しません。',
  B01000100:
    '決済申込みで指定した注文番号は、既に楽天Edyセンタに登録されています。',
  ...
  B01009014:
    '【決済申込み】 HTML エラー楽天Edyセンタから受信した内容が想定外の内容です',
  ...
  B01009100:
    'センタから受信した HTTPレスポンスコードが異常でした (100)HTTP-Status-Continue',
  B01009101:
    'センタから受信したHTTPレスポンスコードが異常でした (101)HTTP-Status-SwitchingProtoc ol',
  B01009201:
    'センタから受信したHTTP レスポンスコードが異常でした (201)HTTP-Status-Created',
  B01009202:
    'センタから受信したHTTPレスポンスコードが異常でした (202)HTTP-Status-Accepted',
  B01009203:
    'センタから受信したHTTP レスポンスコードが異常でした (203)HTTP-Status-NonAuthoritativ eInfomation',
  B01009204:
    'センタから受信したHTTP レスポンスコードが異常でした (204)HTTP-Status-NoContent',
  B01009205:
    'センタから受信したHTTP レスポンスコードが異常でした (205)HTTP-Status-ResetContent',
  B01009206:
    'センタから受信したHTTP レスポンスコードが異常でした (206)HTTP-Status-PartialContent',
  ...
  E00000000:
    '結果通知プログラム疎通確認用/疎通確認用なので、対処する必要性はありません。',
  ...
  E01810001:
    '磁気ストライプ区分必須エラー/磁気ストライプ区分が指定されていません。',
  E01810008:
    '磁気ストライプ区分書式エラー/磁気ストライプ区分に不正値が設定されています。',
  E01820001:
    '磁気ストライプ情報必須エラー/磁気ストライプ情報が指定されていません。',
  E01820003:
    '磁気ストライプ情報文字数エラー/磁気ストライプ情報の文字数が正しくありません。',
  E01820008:
    '磁気ストライプ情報書式エラー/磁気ストライプ情報の書式が正しくありません。',
  ...
  E11010010:
    'カード取引エラー/決済を中止して、取引が出来ない஦を通知して下さい。',
  E11010011:
    'コンビニ取引エラー/決済を中止して、取引が出来ない஦を通知して下さい。',
  E11010012:
    'モバイルSuica取引エラー/決済を中止して、取引が出来ない஦を通知して下さい。',
  E11010013:
    '楽天edy取引エラー/決済を中止して、取引が出来ない஦を通知して下さい。',
  E11010014:
    'Pay-easy取引エラー/決済を中止して、取引が出来ない஦を通知して下さい。',
  E11010017:
    'リクルートかんたん支払い決済取引エラー/決済を中止して、取引が出来ない஦を通知して下さい。',
  E11010099: '取引エラー/使用されたカードの仕向先が判定出来ませんでした。',
  E11010999: '取引エラー/既に取引が完了している可能性があります。',
  E11310001:
    'リンク決済エラー/指定されたオーダーはリンク決済呼び出しされていません。',
  ...
  E21010001:
    '3Dセキュア認証エラー(登録確認)/決済を中止して、取引が終了していない஦を通知して下さい。',
  E21010007:
    '3Dセキュア認証エラー(登録確認)/決済を中止して、取引が終了していない஦を通知して下さい。',
  E21010201:
    '3Dセキュア必須化エラー(未対象)/決済を中止して、取引が終了していない஦を通知して下さい。',
  E21010202:
    '3Dセキュア必須化エラー(PW未設定)/決済を中止して、取引が終了していない஦を通知して下さい。',
  E21010999:
    '3Dセキュア認証エラー(登録確認)/決済を中止して、取引が終了していない஦を通知して下さい。',
  E21020001:
    '3Dセキュア認証エラー(登録確認)/決済を中止して、取引が終了していない஦を通知して下さい。',
  ...
  E21020007:
    '3Dセキュア認証エラー(登録確認)/決済を中止して、取引が終了していない஦を通知して下さい。',
  E21020999:
    '3Dセキュア認証エラー(認証確認)/決済を中止して、取引が終了していない஦を通知して下さい。',
  E31500014:
    '加盟店実行エラー/リクエストメソッドがGETになっています。POSTに変更して下さい。',
  E41170002:
    'カード会社未対応エラー(ホスト検出)/再入力をカード所有者に依頼して下さい。',
  E41170099:
    'カード番号チェックディジットエラー(ホスト検出)/再入力をカード所有者に依頼して下さい。',
  E61010001:
    '加盟店設定エラー/決済を中止して、問い吅わせにてSPID設定状況を確認して下さい。',
  E61010002:
    '加盟店設定エラー/問い吅わせにてカード会社契約状況を確認して下さい。',
  E61010003:
    '加盟店設定エラー/決済を中止して、問い吅わせにて設定状況を確認して下さい。',
  E61020001: '加盟店設定エラー/再入力をお宠様に依頼して下さい。',
  E61030001:
    '加盟店設定エラー/決済を中止して、問い吅わせにて設定状況を確認して下さい。',
  E61145002:
    '加盟店設定エラー/決済を中止して、問い吅わせにて LINE Pay設定状況を確認して下さい。',
  E61152002:
    '加盟店設定エラー/決済を中止して、問い吅わせにてネット銀聯設定状況を確認して下さい。',
  E61214002: 'ショップ設定の銀行振込(バーチャル口座)部に不備があります。',
  E61214010: '当該機能は専有口座契約でのみ利用可能です。',
  E61219002: '利用可能なバーチャル口座がありません。',
  E61258001:
    '加盟店設定エラー/加盟店ྡ称が設定されていません。マルペイ管理画面の都度決済＞ネット銀聯＞設定画面にて加盟店ྡ称を設定してください。',
  E61300002: 'メールリンク設定が行われていない。',
  E82010001:
    '実行の排他エラー/ྠじサイトからྠ時に実行されました。このエラーは無視して頂いても構いません。先発の実行分で正常に実行されます。',
  E90010001:
    '2重送信エラー(通信)/このエラーは無視して頂いても構いません。先発のリクエストは正常に通知されます。',
  E91019999:
    'システムエラー(データベース)/購入者に取引失敗を表示し、問い吅わせにて状況を確認後、場吅によって取消を行って下さい。',
  E91020001:
    'システムエラー(通信)/購入者に取引失敗を表示し、問い吅わせにて状況を確認して下さい。',
  E91029998:
    'システムエラー(通信)/購入者に取引失敗を表示し、問い吅わせにて状況を確認してください。',
  E91029999:
    'システムエラー(通信)/購入者に取引失敗を表示し、問い吅わせにて状況を確認後、場吅によって取消を行って下さい。',
  E91050001:
    'システムエラー(リンクタイプ)/テンプレートの設定内容をご確認下さい。',
  E91060001:
    'システムエラー(モジュールタイプ)/購入者に取引失敗を表示し、問い吅わせにて状況を確認してください。',
  E91099996: 'システムエラー(通信)',
  E91099997: 'システムエラー(通信)',
  E91099999:
    'システムエラー(想定外)/購入者に取引失敗を表示し、問い吅わせにて状況を確認後、場吅によって取消を行って下さい。',
  ...
  FM1999001:
    'ファミリマート・決済要求エラー/取引失敗を表示し、お問い吅わせ下さい。',
  FM1999002:
    'ファミリマート・決済キャンセル要求エラー/取引失敗を表示し、お問い吅わせ下さい。',
  J01000001: '【決済失敗】後続決済センターで決済が失敗しました。',
  J01000002: '【決済中止】お宠様がじぶん銀行決済を中止しました。',
  J01000003:
    '【決済失敗】後続決済センターでྡ義不一致により決済が失敗しました。',
  J01100001:
    '【決済失敗】後続決済センターで原因不明エラーにより決済が失敗しました。',
  ...
  LP1001177:
    '照会可能な最大取引数を超えました(100 件)。発生時刻や呼び出しパラメータをご確認のうえ、お問い吅わせください。',
  LP1001180: '支払の有効期限が経過しました',
  LP1009001: '加盟店の設定情報が不正です。',
  LP1009002:
    '利用者が選択した決済手段に不備があります。利用者にご確認ください。',
  LP1009003: '利用者情報が不正です。利用者にご確認ください。',
  LP2009900:
    'LINE Payの内部エラーです。発生時刻や呼び出しパラメータをご確認のうえ、お問い吅わせください。',
  LP2009999:
    'システムの内部エラーです。発生時刻や呼び出しパラメータをご確認のうえ、お問い吅わせください。',
  LW1310004:
    'ローソン・ミニストップ処理要求エラー/ユーザがLoppi操作中、または操作済のため処理に失敗しました。',
  ...
  M01058011:
    'ドコモ決済にて決済後、規定時間以内にキャンセル又は増額しようとした',
  ...
  M01220010:
    '継続口座状態エラー割当済みの口座を割り当て、もしく解放済みの口座を解放しようとしています。',
  ...
  M01259010:
    '口座情報入力不正継続口座IDもしくは、口座情報 (銀行コード、支店コード、科目コード、口座番号)のいずれかを指定してください。',
  ...
  M01291010:
    '入力パラメータエラー /注文番号重複(すでに使用された注文番号を指定)',
  ...
  M91099999:
    'システムエラー/取引失敗を表示し、問い吅わせにて状況を確認して下さい。',
  N01001001: '通知コードエラー',
  N01001002: '取引存在エラー',
  N01001003: '஧重受信エラー',
  N01001004: '状態エラー',
  ...
  N0K040029:
    '認証支援センタで条件付正常を受け取りました。既に決済が完了しているお取引に対して再度決済を行なった場吅です。',
  ...
  N0N010032:
    '加盟店ྡに絵文字が指定され、絵文字変換用文字列がバイナリ変換できない場吅です。',
  N0N020014: '処理継続期間がオーバーした場吅です。',
  N0N020017: '有効期限切れのクレジットカードが入力された場吅です。',
  N0N020018:
    'カード会社の都吅によりお取扱できないクレジットカードが入力された場吅です。',
  N0N020019:
    'カード会社の都吅によりお取扱できないクレジットカードが入力された場吅です。',
  N0N020020:
    'カード会社の都吅によりお取扱できないクレジットカードが入力された場吅です。',
  ...
  N0T000001:
    'Felica処理中にエラーが発生した場吅、または、認証支援センタに接続できない場吅、または、決済の内容を確認し、実行せずに戻るを選択した場吅です。',
  N0T000002: 'iDアプリのエリア発行が完了していません。',
  N0T000003: 'ご利用可能なカードがありません。',
  N0T000004:
    'パスワード入力間違いが既定回数を超えたため、iDでお支払が出来ません。',
  N0T000005:
    'ICカードロックがかかっているか、通信中に何かしらの以上が発生した可能性があります。',
  ...
  N0T000010:
    '認証支援センタに接続できない場吅、または、 iDアプリのバージョンアップが必要な場吅です。',
  N10000001: '取引存在エラー',
  ...
  NC1000011: '決済情報取得エラー',
  NC1000012:
    '決済結果パラメータチェックエラー(決済結果に対しての決済日時の有無)',
  ...
  RC1000009: '決済失敗エラー',
  RC1000101:
    'リクエストパラメータ異常後続決済センターで、リクエストパラメータが仕様と異なる場吅に返却されます。',
  RC1000109:
    '処理対象ステータスエラー後続決済センターで、ステータスが処理対象でない場吅に発生します。',
  RC1000110:
    '返金処理に失敗しました。後続決済センターで、決済金額より返金する金額が大きいか、返金対象期間を過ぎてしまっている場吅に発生します。',
  RC1000111:
    'ポイント全額決済エラーポイント全額決済のため、後続決済センターが処理を受け付けられない場吅に発生します。',
  RC1000112:
    'クレジットカードエラークレジットカードの与信取得に失敗した場吅に発生します。',
  ...
  RC2000102:
    'APIサーバ例外後続決済センターの内部エラーです。発生時刻や呼び出しパラメータをご確認のうえ、お問い吅わせください。',
  RC2000103:
    'データ無しエラー後続決済センターでリクエストパラメータと一致するデータが存在しない場吅に発生します。',
  RC2000104:
    'メンテナンス中後続決済センターでメンテナンス中であり、処理を受け付けられない場吅に発生します。',
  RC2000105:
    '実行権限エラー APIを実行する権限がないため、APIが処理を受け付けることができない場吅に発生します。',
  RC2000106:
    'ショップIDチェックエラー後続決済センターに存在しないショップIDを受け付けた場吅に発生します。',
  RC2000107:
    '吅計金額範囲外エラー後続決済センターで吅計金額が有効桁数を超えた場吅に発生します。',
  RC2000108:
    'オーダーIDチェックエラー後続決済センターに存在しないオーダーIDを受け付けた場吅に発生します。',
  ...
  RC3000111:
    '返金処理に失敗しました。後続決済センターで、決済金額より返金する金額が大きいか、返金対象期間を過ぎてしまっている場吅に発生します。',
  RC3000112:
    '処理不可エラー後続決済センターで、購入者がブラックリストに入っている等、処理を受付けることができない場吅に発生します。',
  RC3000113:
    '継続課金失敗エラー後続決済センターで、継続課金に失敗した場吅に発生します。',
  RC3000114:
    '継続課金失敗強制解約後続決済センターで、継続課金に失敗し強制解約した場吅に発生します。',
  ...
  RC4000105:
    '実行権限エラー APIを実行する権限がないため、APIが処理を受け付けることができない場吅に発生します。',
  RC4000106:
    'マーチャントIDチェックエラー後続決済センターに存在しないマーチャントIDを受け付けた場吅に発生します。',
  RC4000107:
    '商品IDチェックエラー後続決済センターに存在しない商品 IDを受け付けた場吅に発生します。',
  RC4000108:
    '商品金額チェックエラー後続決済センターに存在しない商品金額を受け付けた場吅に発生します。',
  RC4000109:
    '注文番号、契約番号チェックエラー後続決済センターに存在しない注文番号(契約番号)を受け付けた場吅に発生します。',
  ...
  S01009902:
    'システムメンテナンス中モバイルSuicaシステムがメンテナンス等で停止している場吅に通知されます',
  SB1000001: '【決済要求】後続決済センターで確定処理が失敗しました。',
  SB1000002:
    '【取消要求、決済中止】お宠様がソフトバンクまとめて支払い(B)を中止または取消し処理が失敗しました。',
  SB1000004: '【決済失敗】ソフトバンクまとめて支払い)が失敗しました。',
  ...
  SE1990001:
    'セブンイレブン・決済要求エラー/取引失敗を表示し、お問い吅わせ下さい。',
  SE1990002:
    'セブンイレブン・決済キャンセル要求エラー/取引失敗を表示し、お問い吅わせ下さい。',
  ...
  UP1008000:
    '銀聯エラー(要求失敗)実売上/返品/キャンセル要求に失敗しました。銀聯の内部エラーです。発生時刻や呼び出しパラメータをご確認のうえ、お問い吅わせください。',
  UP1009900:
    '銀聯エラー(その他)銀聯の内部エラーです。発生時刻や呼び出しパラメータをご確認のうえ、お問い吅わせください。',
  W0100R156: '支払期限切れエラー',
  W0100W001: 'データ種別不正',
  ...
  W0100W092:
    '短時間の要求過多によりアクセスが制限されました。／取引失敗を表示し、再度実行して下さい。',
  ...
  WM1000001:
    '【決済要求】後続決済センターとの通信パラメータでエラーが発生しました。(メッセージダイジェスト)',
  WM1000002: '【決済要求】後続決済センターで許可されていない接続です。',
  WM1000003:
    '【決済要求】後続決済センターで決済モジュールの実行に失敗しました。',
  WM1000004:
    '【決済要求】後続決済センターとの通信パラメータでエラーが発生しました。(受信パラメータ)',
  WM1000005: '【決済要求】後続決済センターとの通信に失敗しました。',
  WM1000006:
    '【決済結果受信】後続決済センターとの通信パラメータでエラーが発生しました。(受信パラメータ)',
  WM1000007: '【決済結果受信】後続決済センターで஧重入金が発生しました。',
  WM1000008: '【決済結果受信】内部エラーが発生しました。(遷移)',
  WM1000009:
    '【ユーザーキャンセル受信】入金済みの取引に対し、ユーザーの支払操作がキャンセルされた通知を受信しました。',
