...
CREATE TABLE LP_ORDER (
    ...
    buyer_id VARCHAR(36),
    store_id VARCHAR(36),
    receiver_id VARCHAR(36), -- để làm gì đây Quang
    order_status INT,
    amount INT UNSIGNED NOT NULL,  -- tổng amount của item
    shipment_fee INT,
    discount INT,
    total_amount INT UNSIGNED NOT NULL, -- = amount + shipment_fee - discount
    cancel_at DATETIME,
    created_at DATETIME,
...
CREATE TABLE LP_SHIPMENT (
    ...
    shipment_start_at DATETIME,
    shipment_end_at DATETIME,
